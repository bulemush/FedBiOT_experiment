...
# Respect user-provided Hugging Face env vars instead of forcing one endpoint.
# This makes it possible to switch between the official hub, a mirror,
# or a fully offline local cache from the shell.
hf_endpoint = os.environ.get("FEDBIOT_HF_ENDPOINT") or os.environ.get(
    "HF_ENDPOINT")
if hf_endpoint:
